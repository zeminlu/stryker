...
CLASS START
   ...
   /**
    ...
    public void test(Class<?> clazz, Method method) throws IllegalAccessException,InvocationTargetException, InstantiationException {
    	Class<?> instance = INSTANCE VALUE;
